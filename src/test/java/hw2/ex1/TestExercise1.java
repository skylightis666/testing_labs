...
public class TestExercise1 extends BaseTest {
    ...
    public void testExercise1(){
        ...
        for(int i = 0; i < expectedName.length; i++){
            softAssert.assertEquals(headerMenuSelectors.get(i).getText(), expectedName[i]);
            softAssert.assertTrue(headerMenuSelectors.get(i).isDisplayed());
        }
        ...
        for(int i = 0; i < expectedLeftMenuItems.length; i++){
            softAssert.assertEquals(leftMenuItems.get(i).getText(),expectedLeftMenuItems[i]);
